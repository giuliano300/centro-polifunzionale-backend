...
export class WalletMovement extends Document {
  ...
  @Prop({ required: true, enum: ['cancellation_refund', 'course_refund', 'booking_hold_release', 'course_hold_release', 'booking_payment', 'course_payment', 'signup_bonus', 'manual'] })
  reason: 'cancellation_refund' | 'course_refund' | 'booking_hold_release' | 'course_hold_release' | 'booking_payment' | 'course_payment' | 'signup_bonus' | 'manual';
